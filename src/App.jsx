        ...
        return <React.Fragment>
             ...
             <div className="main-container">
                <div className="product-container">
                    ...
                    <Product onAdd={() => this.addItem(1, 'Gurken', 1.99)} image="cucumbers.jpg" title="Gurken" description="Füge Gurken zu deinem Warenkorb hinzu" />
                    ...
                    <Product onAdd={() => this.addItem(1, 'Avocado', 5.99)} image="avocados.jpg" title="Avocado" description="Füge Avocados zu deinem Warenkorb hinzu" />
                </div>
